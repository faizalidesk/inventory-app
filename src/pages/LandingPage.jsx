...
const DEFAULT_LANDING_CONTENT = {
  ...
  about_title: "Independent studio crafting interfaces with intent.",
  about_large_copy: "We build websites and software that focus on clarity, motion, and crafted detail.",
  about_description: "Bridging modern frontend engineering and product design, Desktopalie helps teams and creators bring ambitious digital concepts to life with clean code and refined interactions.",
  ...
  return (
    <TooltipProvider delayDuration={150}>
      ...
      <div className="desktopalie" data-theme={theme}>
        ...
        {/* 1. UNIFIED SITE HEADER / NAVBAR */}
        <SiteNavbar activeNav="home" />
