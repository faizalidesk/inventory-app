...
export const PLATFORMS = {
  ...
  beta: {
    ...
    name: "Beta Platform",
    code: "BETA 🌿",
    category: "SMART LOGISTICS & TELEMETRY",
    tagline: "Emerald Hub • Real-Time Fleet Telemetry & Route Intelligence",
    heroTitle: "Precision Fleet Telemetry & IoT Logistics.",
    heroSubtitle: "Real-time cold-chain vehicle tracking, automated route calculation, distance matrix analysis, and sub-second IoT sensor telemetry.",
    heroBadge: "🌿 PLATFORM BETA • SMART LOGISTICS LAB",
    color: "#10B981",
    colorHover: "#059669",
    ...
    logoSymbol: "🌿",
    stats: [
      { label: "Active Fleet Telemetry", value: "150+" },
      { label: "GPS Sensor Uptime", value: "99.99%" },
      { label: "Telemetry Latency", value: "< 1.2ms" },
    ],
    features: [
      "Real-time Cold-Chain GPS Tracking",
      "Automated Distance Matrix Route Calculations",
      "Driver Behavior & Fuel Efficiency Analytics",
    ],
  },
  gamma: {
    id: "gamma",
    name: "Gamma Platform",
    code: "GAMMA 🤖",
    category: "AGENTIC AI & VIDEO CLOUD",
    tagline: "Purple Core • Agentic AI & Cloud Video Intelligence",
    heroTitle: "Autonomous Agentic AI & Cloud Video Intelligence.",
    heroSubtitle: "Harnessing multimodal agentic AI, Google Cloud Video Intelligence, automated scene detection, speech-to-text captions, and high-throughput transcoding pipelines.",
    heroBadge: "🤖 PLATFORM GAMMA • AGENTIC AI LAB",
    color: "#8B5CF6",
    colorHover: "#7C3AED",
    ...
    logoSymbol: "🤖",
    stats: [
      { label: "Agentic Reasoning Latency", value: "< 45ms" },
      { label: "AI Video Intelligence", value: "99.4% Accuracy" },
      { label: "Transcode Speed", value: "4.8x Realtime" },
    ],
    features: [
      "Autonomous Multimodal Agentic Workflow",
      "Google Cloud Video Intelligence & Scene Detection",
      "Automated Multi-language Caption & Subtitle Generation",
    ],
  },
  delta: {
    id: "delta",
    name: "Delta Platform",
    code: "DELTA ⚡",
    category: "ENTERPRISE ERP & OCR SUITE",
    tagline: "Amber Suite • Multi-Tenant ERP & Intelligent OCR Finance",
    heroTitle: "Intelligent Enterprise ERP & Financial OCR.",
    heroSubtitle: "Transforming invoices and purchase orders into structured general ledger accounting with Google Cloud Vision OCR and multi-tenant RBAC security.",
    heroBadge: "⚡ PLATFORM DELTA • ENTERPRISE ERP",
    color: "#F59E0B",
    colorHover: "#D97706",
    ...
    logoSymbol: "⚡",
    stats: [
      { label: "OCR Recognition Accuracy", value: "99.9%" },
      { label: "Multi-Tenant Entities", value: "500+ Tenants" },
      { label: "Automated Ledger Sync", value: "Realtime" },
    ],
    features: [
      "Intelligent Document OCR Scanner & Parser",
      "Automated Double-Entry General Ledger",
      "Role-Based Access Control (RBAC) Security Shield",
    ],
  },
};
